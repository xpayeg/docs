...
| amount                    | float   | represents the amount you want to charge the user | if your community fees is included in bill then use the value returned from [prepare amount endpoint](prepare_amount.md) , otherwise use the amount you want to charge the user directly. |
