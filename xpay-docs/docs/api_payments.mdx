...
<img alt="API Payment section" src={useBaseUrl("img/guides/api_payment.png")} />

3. Click on **add variable amount** button in the top right corner.

<img alt="Add an API Payment form" src={useBaseUrl("img/guides/api_payment_form.png")} />
...
<img alt="new API Payment created" src={useBaseUrl("img/guides/api_payment_list.png")} />
