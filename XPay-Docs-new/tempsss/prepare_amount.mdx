...
Note: depending on the agreement with XPay, if your community's service fees are **included in bill**, you do not need to use this endpoint. [skip to next step](pay.mdx)
