...
to add custom fields to your API payment template follow the same steps in [create API payment](api_payments.mdx) or navigate to your api payment template then :

1. Navigate to the end of the form, you will find the **custom fields** section

   <img
     alt="custom fields section"
     src={useBaseUrl("img/guides/custom_fields.png")}
   />
...
5. Click on **Add another custom field** if you wish to add more custom field.
   <img
     ...
     src={useBaseUrl("img/guides/another-custom-field.png")}
   />
6. **SAVE** 
