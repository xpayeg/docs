...
to add custom fields to your API payment template follow the same steps in [create API payment](api-payment.mdx) or navigate to your api payment template then :
